...
def hkdf_extract_expand_label(
    salt, input_key_material, label, context, length=32, hash_algorithm=hashlib.sha256
):
...
derived_secret = hkdf_extract_expand_label(
    zero_salt, b"\x00" * 32, b"derived", empty_hash
)
